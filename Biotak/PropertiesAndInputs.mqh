...
input ENUM_QUICK_TEST_PRESET inpQuickTestPreset = QUICK_PRESET_TRIGGER_PATTERN;
input ENUM_COMBO_STEP_TYPE inpQuickTestStepType = COMBO_STEP_TH;
input ENUM_MEAN_TYPE inpQuickTestMeanType = MEAN_GEOMETRIC;
